package clases;
// Generated 15 dic 2022 13:04:52 by Hibernate Tools 6.1.3.Final
...
public class Departamentos implements java.io.Serializable {
	...
	public Departamentos(int numero) {
		this.numero = numero;
	}

	public Departamentos(int numero, String nombre, Set<Empleados> empleadoses) {
		this.numero = numero;
		this.nombre = nombre;
