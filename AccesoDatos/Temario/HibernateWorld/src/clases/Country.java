package clases;
// Generated 15 dic 2022 16:40:16 by Hibernate Tools 5.6.12.Final
...
public class Country implements java.io.Serializable {
	...
	public Country(String code, String name, String continent, String region, BigDecimal surfaceArea, Short indepYear,
			...
			String governmentForm, String headOfState, Integer capital, String code2, Set<Countrylanguage> countrylanguages,
			Set<City> cities) {
		this.code = code;
		this.name = name;
		this.continent = continent;
