...
public class ListadoLanguageConGet {
	...
	public static void main(String[] args) {
		...
		System.out.println("=============================================================================================================");
		System.out.printf("Datos del país %4s%n",args[0]);
		...
		if(country != null) {
			...
			System.out.printf("Número de idiomas: %d %n", listalenguajes.size());
			
			for(Countrylanguage ciudades : listalenguajes) {
				
				System.out.printf("Nombre: %15s - Percentaje: %4s - EsOficial: %s %n",  ciudades.getId().getLanguage(), ciudades.getPercentage().toString(),ciudades.getIsOfficial());
			}
			System.out.println("=============================================================================================================");
			}
		else {
